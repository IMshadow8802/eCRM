// app.config.js — the single source of truth for native configuration.
//
  ...
  expo: {
    ...
    ios: {
      ...
      bundleIdentifier: IS_DEV
        ? "com.shadowider.eCRM.dev"
        : "com.shadowider.eCRM",
      infoPlist: {
        // Shown verbatim in the iOS permission dialog. iOS rejects the build at
        // review — and crashes the picker at runtime — if the matching key is
        // missing, so each picker below has its string here.
