...
const Priorities = () => {
  ...
  const saveMutation = useApiMutation({
    ...
    successMessage: `Priority ${editingLookup ? "updated" : "created"} successfully!`,
    invalidateQueries: [["lookups", KIND]],
    onSuccess: closeModal,
    showErrorMessage: false,
    onError: (error) =>
      enqueueSnackbar(errorText(error, "Failed to save priority"), { variant: "error" }),
  });
  ...
  const deleteMutation = useApiMutation({
    ...
    showErrorMessage: false,
    onError: (error) =>
      enqueueSnackbar(errorText(error, "Failed to delete priority!"), { variant: "error" }),
  });
